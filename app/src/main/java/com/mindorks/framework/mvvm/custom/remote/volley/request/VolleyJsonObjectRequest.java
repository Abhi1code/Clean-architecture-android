...
public class VolleyJsonObjectRequest extends JsonRequest<JSONObject> implements RequestInterface {
    ...
    public VolleyJsonObjectRequest(final VolleyRequestParams volleyRequestParams,
        ...
        super(volleyRequestParams.getMethod(),
                ...
                VolleyListenerHandlers.objectListenerHandler(responseListener, volleyRequestParams.getResponseType()),
