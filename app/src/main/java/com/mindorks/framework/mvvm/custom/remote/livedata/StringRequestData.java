...
public class StringRequestData<T> extends LiveData<StateData<T>>
    ...
    public StringRequestData(@NonNull final Class<T> clazz,
                             @NonNull final VolleyRequestParams volleyRequestParams) {
        this.clazz = clazz;
        this.volleyRequestParams = volleyRequestParams;
        this.requestInterface = VolleyRequest.createVolleyStringRequest(this.volleyRequestParams,
