...
public class JsonArrayRequestData<T> extends LiveData<StateData<T>>
    ...
    public JsonArrayRequestData(@NonNull final Class<T> clazz,
                                 @NonNull final VolleyRequestParams volleyRequestParams) {
        this.clazz = clazz;
        this.volleyRequestParams = volleyRequestParams;
        this.requestInterface = VolleyRequest.createVolleyJsonArrayRequest(this.volleyRequestParams,
